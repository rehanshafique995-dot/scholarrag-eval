from src.retrieval.section_dense_retriever import (
    build_section_dense_index,
    search as dense_search,
)

from src.retrieval.section_bm25_retriever import (
    build_section_bm25_index,
...
def section_hybrid_search(
    ...
    """Combine section-aware dense and section-aware BM25 retrieval."""
    ...
    for result in dense_results:
        key = (result["paper_id"], result["section"], result["chunk_id"])
        combined[key] = {
            **result,
